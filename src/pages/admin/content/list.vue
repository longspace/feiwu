      ...
      data() {
        return {
          ...
          formcfg:{
            ...
            data:[
              {type:'TreeSelect',label:'',field:'cate_id',icon:'control',itemstyle:{},style:{width:'290px'},placeholder:'所属分类',checkable:true,options:[]},
              {type:'Input',label:'',field:'keywords',icon:'align-left',style:{width:'260px'},placeholder:'文章ID、标题、关键词、描述'},
          ...
          tablecfg: {
              headerOptions:[
                  { title: 'ID', field: 'id', width:'55px'},
                  { title: '所属分类', field: 'cate_id',width:'120px'},
                  { title: '缩略图', field: 'thumb',width:'115px',fieldType:'image'},
                  { title: '标题', field: 'title'},
                  { title: '阅读数', field: 'hits',width:'80px'},
                  { title: '审核', field: 'status',width:'80px',fieldType:'status',showText:["否","是"]},
