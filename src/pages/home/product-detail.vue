      ...
      <div class="product-info-top">
        <div class="product-carousel" v-if="productInfo.carousel.length">
          ...
          <!-- <div class="gallery-swiper">
            <div class="swiper-container gallery-container" id="#gallery">
              <div class="swiper-wrapper">
                <div
                  class="swiper-slide"
                  v-for="thumbItem in productInfo.carousel"
                  :key="thumbItem.id"
                >
                  <img :src="thumbItem.bigUrl" alt="" />
                </div>
              </div>
            </div>
          </div>
          <div class="thumbs-swiper">
            <div class="swiper-container thumbs-container" id="#thumbs">
              <div class="swiper-wrapper">
                <div
                  class="swiper-slide"
                  v-for="thumbItem in productInfo.carousel"
                  :key="thumbItem.id"
                >
                  <img :src="thumbItem.smallUrl" alt="" />
                </div>
              </div>
