...
// 内容管理
export const articleList = (data={}) => request.post("content/articleList",data)
export const articleHandle = (data={}) => request.post("content/articleHandle",data)
export const articleDelete = (data={}) => request.post("content/articleDelete",data)
export const articleDetails = (data={}) => request.post("content/articleDetails",data)


export const categoryList = (data={}) => request.post("content/categoryList",data)
export const categoryHandle = (data={}) => request.post("content/categoryHandle",data)
export const categoryDelete = (data={}) => request.post("content/categoryDelete",data)
...
export const webSiteHandle = (data={}) => request.post("configs/webSiteHandle",data) //站点配置

export const roleList = (data={}) => request.post("configs/roleList",data)
export const rolePermission = (data={}) => request.post("configs/rolePermission",data)
export const roleHandle = (data={}) => request.post("configs/roleHandle",data)
export const roleDelete = (data={}) => request.post("configs/roleDelete",data)

export const userList = (data={}) => request.post("configs/userList",data)
export const userHandle = (data={}) => request.post("configs/userHandle",data)
export const userDelete = (data={}) => request.post("configs/userDelete",data)

// 商品模块
export const goodsCategoryList = (data={}) => request.post("goods/categoryList",data)
export const goodsCategoryHandle = (data={}) => request.post("goods/categoryHandle",data)
export const goodsCategoryDelete = (data={}) => request.post("goods/categoryDelete",data)

export const goodsCategorySonList = (data={}) => request.post("goods/categorySonList",data)
export const goodsCategorySonHandle = (data={}) => request.post("goods/categorySonHandle",data)
export const goodsCategorySonDelete = (data={}) => request.post("goods/categorySonDelete",data)
...
export const companyDelete = (data={}) => request.post("company/companyDelete",data)
export const verifyCompanyInfo = (data={}) => request.post("company/verifyCompanyInfo",data)


export const callRoleList = (data={}) => request.post("call/roleList",data) // 角色列表
export const callCategoryList = (data={}) => request.post("call/categoryList",data) // 分类列表
